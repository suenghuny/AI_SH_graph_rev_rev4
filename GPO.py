...
class Agent:
    def __init__(self,
        ...
        self.func_meta_path2 = GCRN(feature_size=cfg.n_representation_action,
                                    ...
                                    num_node_cat=1,
                                    num_edge_cat=5).to(device)
        self.func_meta_path3 = GCRN(feature_size=cfg.n_representation_action2,
                                    embedding_size=cfg.n_representation_action2,
                                    graph_embedding_size=cfg.hidden_size_meta_path2,
                                    layers=node_embedding_layers_missile,
                                    num_node_cat=1,
                                    num_edge_cat=5).to(device)
        self.func_meta_path4 = GCRN(feature_size=cfg.n_representation_action2,
                                    embedding_size=cfg.n_representation_action2,
                                    graph_embedding_size=cfg.hidden_size_meta_path2,
                                    layers=node_embedding_layers_missile,
                                    num_node_cat=1,
                                    num_edge_cat=5).to(device)
        self.func_meta_path5 = GCRN(feature_size=cfg.n_representation_action2,
                                    embedding_size=cfg.n_representation_action2,
                                    graph_embedding_size=cfg.hidden_size_meta_path2,
                                    layers=node_embedding_layers_missile,
                                    num_node_cat=1,
                                    num_edge_cat=5).to(device)
        self.func_meta_path6 = GCRN(feature_size=cfg.n_representation_action2,
                                    embedding_size=cfg.n_representation_action2,
                                    graph_embedding_size=cfg.hidden_size_meta_path2,
                                    layers=node_embedding_layers_missile,
                                    num_node_cat=1,
