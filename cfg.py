...
def get_cfg():
    ...
    parser.add_argument("--n_representation_action", type=int, default=64, help="")
    parser.add_argument("--n_representation_action2", type=int, default=64, help="")
    ...
    parser.add_argument("--angle_random", type=bool, default=False, help="number of multi head")
    parser.add_argument("--inception_angle", type=float, default=22.5, help="number of multi head")
    parser.add_argument("--n_test", type=int, default=200, help="number of multi head")
